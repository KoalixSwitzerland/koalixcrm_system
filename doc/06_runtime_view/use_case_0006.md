...
**ID:** UC-0006  
**Bezug:** [ADR-0007](../09_architecture_decisions/0007-service-profile.md), [REQ-0016](../01_introduction_and_goals/requirements/REQ-0016.md)  
...
## Referenzen
- [ADR-0007](../09_architecture_decisions/0007-service-profile.md) — `ServiceProfile`-Modell
- [ADR-0019](../09_architecture_decisions/0019-product-kind-invariants.md) — `kind`-Gating: `ServiceProfile` ausschließlich für `kind = SERVICE`
- [REQ-0016](../01_introduction_and_goals/requirements/REQ-0016.md) — governing requirement
- [Glossar](../12_glossary/glossar.md) — Begriffsdefinitionen (`ServiceProfile`, `kind`)
