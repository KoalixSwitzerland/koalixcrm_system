...
**ID:** UC-0005  
**Bezug:** [ADR-0006](../09_architecture_decisions/0006-sourcing-and-bill-of-materials.md), [REQ-0015](../01_introduction_and_goals/requirements/REQ-0015.md)  
...
## Referenzen
- [ADR-0006](../09_architecture_decisions/0006-sourcing-and-bill-of-materials.md) — `BillOfMaterials`/`BomItem`-Modell
- [ADR-0019](../09_architecture_decisions/0019-product-kind-invariants.md) — `kind`-Gating: `BillOfMaterials` ausschließlich für `kind = MANUFACTURED_GOOD`
- [REQ-0015](../01_introduction_and_goals/requirements/REQ-0015.md) — governing requirement
- [Glossar](../12_glossary/glossar.md) — Begriffsdefinitionen (`BillOfMaterials (BOM)`, `BomItem`, `kind`)
