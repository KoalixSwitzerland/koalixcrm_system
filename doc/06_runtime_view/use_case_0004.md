...
**ID:** UC-0004  
**Bezug:** [ADR-0005](../09_architecture_decisions/0005-pricing-units-of-measure.md), [ADR-0021](../09_architecture_decisions/0021-produkt-variantengranularitaet-topologie-schluesselung-attributkaskade.md), [REQ-0011](../01_introduction_and_goals/requirements/REQ-0011.md), [REQ-0012](../01_introduction_and_goals/requirements/REQ-0012.md)  
...
- Mindestens eine `PartyGroup` (Kundensegment) ist im Workspace konfiguriert ([ADR-0001](../09_architecture_decisions/0001-contact-and-party-data-model.md)).
- Das `Product` existiert im aktiven Workspace und trägt mindestens eine `ProductVariant` ([ADR-0021](../09_architecture_decisions/0021-produkt-variantengranularitaet-topologie-schluesselung-attributkaskade.md): „jedes `Product` besitzt ≥1 `ProductVariant`").
- Ein Preis wird an einer `ProductVariant` angelegt, nicht am `Product` selbst ([ADR-0021](../09_architecture_decisions/0021-produkt-variantengranularitaet-topologie-schluesselung-attributkaskade.md): „`ProductPrice` ... trägt FK → `ProductVariant`"). Trägt das `Product` genau eine `ProductVariant`, wählt die Benutzeroberfläche diese einzige Variante vor.
...
- Das Backend erkennt, dass ein bestehender `ProductPrice`-Eintrag für dieselbe `ProductVariant` und dieselbe Preisliste mit dem neuen Gültigkeitszeitraum überlappt ([ADR-0021](../09_architecture_decisions/0021-produkt-variantengranularitaet-topologie-schluesselung-attributkaskade.md): „`ProductPrice` trägt FK → `ProductVariant`; Preis ist variantenspezifisch").
...
## Referenzen
- [ADR-0005](../09_architecture_decisions/0005-pricing-units-of-measure.md) — Preislisten, `ProductPrice`, `customer_group_transform`
- [ADR-0021](../09_architecture_decisions/0021-produkt-variantengranularitaet-topologie-schluesselung-attributkaskade.md) — `ProductPrice` FK → `ProductVariant` (variantenspezifische Preisschlüsselung)
- [ADR-0001](../09_architecture_decisions/0001-contact-and-party-data-model.md) — `PartyGroup`/Workspace-Scoping
- [REQ-0011](../01_introduction_and_goals/requirements/REQ-0011.md), [REQ-0012](../01_introduction_and_goals/requirements/REQ-0012.md) — governing requirements
- [Glossar](../12_glossary/glossar.md) — Begriffsdefinitionen (`PriceList`, `ProductPrice`, `customer_group_transform`, `PartyGroup`, `ProductVariant`)
