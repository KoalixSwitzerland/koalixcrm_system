...
**ID:** UC-0002  
**Bezug:** [ADR-0004](../09_architecture_decisions/0004-classification-and-extensible-attributes.md), [REQ-0009](../01_introduction_and_goals/requirements/REQ-0009.md), [REQ-0010](../01_introduction_and_goals/requirements/REQ-0010.md)  
...
## Referenzen
- [ADR-0004](../09_architecture_decisions/0004-classification-and-extensible-attributes.md) — `AttributeSet`/`AttributeGroup`/`AttributeDefinition`-Modell
- [ADR-0019](../09_architecture_decisions/0019-product-kind-invariants.md) — `kind`-Gating (AttributeSet-Bindung variiert nach `ClassificationNode` und `kind`)
- [REQ-0009](../01_introduction_and_goals/requirements/REQ-0009.md), [REQ-0010](../01_introduction_and_goals/requirements/REQ-0010.md) — governing requirements
- [UC-0001](use_case_0001.md) — Vorbedingung: das `Product` muss bereits angelegt sein
- [Glossar](../12_glossary/glossar.md) — Begriffsdefinitionen (`AttributeDefinition`, `AttributeSet`, `AttributeGroup`, `kind`)
